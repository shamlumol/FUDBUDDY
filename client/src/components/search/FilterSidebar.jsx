...
import { ChevronDown, Utensils, Tag, MapPin, Star, Heart } from 'lucide-react';
  ...
  return (
    <div className="w-full md:w-64 flex-shrink-0">
      ...
      <div className="mt-8 mb-4 md:hidden">
        <button className="w-full bg-[#8cc63f] text-white rounded-xl py-3.5 font-bold text-[15px] shadow-md hover:bg-[#7ab135] transition-colors">
          Search
        </button>
      </div>
    </div>
